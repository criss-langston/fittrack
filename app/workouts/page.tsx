...
import { Plus, Trash2, ChevronDown, ChevronUp, Trophy, X, Save, FolderOpen, Link, Unlink, Lightbulb, FileText, Activity, Download, Filter, LayoutTemplate, Dumbbell } from "lucide-react";
...
interface Workout { programId?: string; id: string; date: string; exercises: Exercise[]; duration?: number; notes?: string; rpe?: number; supersets?: SupersetGroup[]; }
...
const TAB_OPTIONS = ['log', 'templates', 'exercises'] as const;
...
export default function WorkoutsPage() {
  ...
  useEffect(() => { loadWorkouts(); loadExerciseNames(); loadTemplates(); loadProgramsData(); }, [loadWorkouts, loadExerciseNames, loadTemplates, loadProgramsData]);
